...
:a*+5$a;:a=KF*p5$a<<<<<;pointer-corrector-simple;
:a*-1$a;:a=KF*m1$aERROR;pointer-corrector-boundries;
:a;:a=KF;allcation
>:a$a;>:a=KF$a<;pointer1
...
:b{a$a}{a$a};:b=KE{a=KF}{a=KF}ERROR;macro-redefinition-error;
:a{a};:a=KF{a=KF}ERROR;macro-empty-error;
...
{bba}&b;{bba=LD}ERROR;macro-variable-long-body-empty-error;
...
260+;;multiplication-multiple-overflow-might-happen;
...
~"az";~+>------>>++++[-<++++>]<[-<++++++++<++++++>>];create-string;
{a~#az#}&a;{a=KF}&a~+>------>>++++[-<++++>]<[-<++++++++<++++++>>];create-string-buffer;
:a~"az"$a;:a=KF~+>------>>++++[-<++++>]<[-<++++++++<++++++>>]$a<<;create-string-offset;
{a~"{}"}&a;{a=KF}&a~----->--->>++++[-<++++>]<[-<++++++++<++++++++>>];create-string-in-macro-with-special;
|"test";|>++++++++++[-<+++++++++++>]<++++++.>++++[-<---->]<+.++++++++++++++.+.;print-string;
{a|#az#}&a;{a=KF}&a|>++++++++++[-<++++++++++>]<---.>+++++[-<+++++>]<.;print-string-buffer;
{a|"{}"}&a;{a=KF}&a|>+++++++++++[-<+++++++++++>]<++.++.;print-string-in-macro-with-special;
|"test;|>++++++++++[-<+++++++++++>]<++++++.>++++[-<---->]<+.++++++++++++++.+.;print-string-eof;
{a#&b#abcdefghijklmnopq}{b#5<}&a;{a=KF}{b=KE}&a#&b#5<<<<<#abcdefghijklmnopq;multiply-in-buffer;
:a{a#&b#abcdefghijklmnopq}{b#5<}&a$a;:a=KF{a=KF}{b=KE}&a#&b#5<<<<<#abcdefghijklmnopq$aERROR;multiply-in-buffer-error;
{};{ERROR;macro-no-name
